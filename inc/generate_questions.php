...
//         $questions[$i]['leftAdder'] = $leftAdder;
//         $questions[$i]['rightAdder'] = $rightAdder;
//         $questions[$i]['correctAnswer'] = $correctAnswer;
//         $questions[$i]['firstIncorrectAnswer'] = $firstIncorrectAnswer;
//         $questions[$i]['secondIncorrectAnswer'] = $secondIncorrectAnswer;
